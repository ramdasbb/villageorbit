...
const PeopleSection = ({ people, sectionId }: PeopleSectionProps) => {
  ...
  return (
    <>
      <section
        id={sectionId}
        className="py-10 sm:py-14 md:py-16 lg:py-20 bg-gradient-to-b from-background to-muted/30"
      >
    ...
    <div className="text-center mb-8 sm:mb-12 md:mb-16 animate-fade-in">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-gradient">
        {t(`${sectionId}Workers.title`)}
      </h2>

      <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-2">
        {t(`${sectionId}Workers.description`)}
      </p>
    </div>
            ...
            {people.map((person, index) => (
              ...
              >
                <CardHeader className="text-center p-3 sm:p-4 md:p-6">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-2 sm:mb-3 rounded-full overflow-hidden border-2 border-accent hover:border-primary transition-colors">
                    <img
                      src={person.image}
                      alt={person.name}
